...
subtitle: "This presentation: [https://lgraz.com/2026-05-06--commitee-Meeting/](https://lgraz.com/2026-05-06--commitee-Meeting/)"
date: 06. May 2026
...
The $i$-th entry of $\mOmega \, \hvec(\mY)$:
...
- $\hvec(\mY \mid \xvec) = (h_1(Y_1 \mid \xvec), \dots, h_J(Y_J \mid \xvec))^\top$
  - Linear shift: $\hvec(\mY \mid \xvec) = \hvec(\mY) - (\betavec_1, \dots, \betavec_J)^\top\xvec$
    ...
    - Add scaling: $h_j(y_j \mid \xvec) = \mathrm{e}^{\gammavec_j(\xvec)} h_j(y_j) - {\betavec_j}^\top\xvec$
...
- [x] Achieved consistent results for common examples
- [x] Transformations:
    - Ordinal
...
- [ ] Initiate a collaboration with SEM experts (e.g., Prof. Yves Rosseel)
- [ ] Simulation Study:
...
- **Challenge:** How can we make only specific elements of $\mA$ covariate-dependent?
...
2. _SEMs via MTMs_
    - [x] Proof of Concept
    - [ ] Submit by the end of 2026
    - [ ] Review process throughout 2027

3. _Covariate-Dependent SEMs via MTMs_
    - [ ] Submit by the end of 2027
    - [ ] Review process throughout 2028
